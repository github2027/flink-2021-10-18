...
public class Flink02_WordCount_Bounded {
    public static void main(String[] args) throws Exception {
        ...
        //3.压平并将单词转换成元组
        SingleOutputStreamOperator<Tuple2<String, Integer>> wordsToOneDS = input.flatMap(new LineToTupleFlatMapFunc());

        //4.分组
        KeyedStream<Tuple2<String, Integer>, String> keyedStream = wordsToOneDS.keyBy(new KeySelector<Tuple2<String, Integer>, String>() {
            @Override
